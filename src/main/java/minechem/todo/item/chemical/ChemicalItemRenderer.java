package minechem.todo.item.chemical;
...
import minechem.todo.client.render.ILayer;
import minechem.todo.client.render.IconLayer;
import minechem.todo.client.render.TextLayer;
...
public class ChemicalItemRenderer implements IItemRenderer {
	...
	public boolean handleRenderType(ItemStack item, ItemRenderType type) {
		ChemicalBase chemicalBase = ItemChemical.getChemicalBase(item);
	...
	public void renderItem(ItemRenderType type, ItemStack itemStack, Object... data) {
		...
		ItemChemical item = (ItemChemical) itemStack.getItem();
		ChemicalBase chemicalBase = ItemChemical.getChemicalBase(itemStack);
