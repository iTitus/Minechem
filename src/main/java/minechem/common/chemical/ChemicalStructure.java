...
public class ChemicalStructure {
	...
	/**
	 * Add a {@link minechem.common.chemical.ChemicalBase} with given count to the structure
	 *
	...
	/**
	 * Add a {@link minechem.common.chemical.ChemicalBase} to the structure, the count will be one
	 *
	 * @param chemicalBase the chemical
	 */
	...
	/**
	 * Generates the formula for the {@link minechem.common.chemical.ChemicalStructure }
	 *
	 * @return
	 */
	...
	/**
	 * Node class for the {@link minechem.common.chemical.ChemicalStructure}
	 */
	public static class ChemicalBaseSet {
		...
		/**
		 * Get the {@link minechem.common.chemical.ChemicalBase}
		 *
		 * @return
		 */
		...
		/**
		 * Get the amount of the give {@link minechem.common.chemical.ChemicalBase}
		 *
		 * @return
		 */
		public int getCount() {
