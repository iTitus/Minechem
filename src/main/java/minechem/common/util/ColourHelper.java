 ...
 * <p>
 * getRed/getBlue/getGreen returns the RGB from a {@link minechem.common.Compendium.Color.TrueColor} value eg: getBlue(Compendium.TrueColor.green) returns 0.0F getGreen(Compendium.TrueColor.green) returns
 * 1.0F getRed(Compendium.TrueColor.green) returns 0.0F
 */
public class ColourHelper {

	/**
	 * Convert an RGB value to {@link minechem.common.Compendium.Color.TrueColor}
	 *
	 * @param red
	 * @param green
	 * @param blue
	 * @return {@link minechem.common.Compendium.Color.TrueColor} value
	 */
	...
	/**
	 * Convert an #RRGGBB value to {@link minechem.common.Compendium.Color.TrueColor}
	 *
	 * @param colour the #RRGGBB value
	 * @return the {@link minechem.common.Compendium.Color.TrueColor} value or an {@link java.lang.IllegalArgumentException} if a mal formed input is given
	 */
	...
	/**
	 * Convert RGBA value to {@link minechem.common.Compendium.Color.TrueColor}
	 *
	 * @param red
	 * @param green
	 * @param blue
	...
	/**
	 * Get the alpha from a {@link minechem.common.Compendium.Color.TrueColor} value
	 *
	 * @param color
	 * @return
	 */
	...
	/**
	 * Get the blue value of a {@link minechem.common.Compendium.Color.TrueColor} value
	 *
	 * @param color
	 * @return
	 */
	...
	/**
	 * Get the green value of a {@link minechem.common.Compendium.Color.TrueColor} value
	 *
	 * @param color
	 * @return
	 */
	...
	/**
	 * Get the red value of a {@link minechem.common.Compendium.Color.TrueColor} value
	 *
