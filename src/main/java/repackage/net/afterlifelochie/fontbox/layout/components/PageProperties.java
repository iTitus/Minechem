...
public class PageProperties {
	 ...
	 * @param w            The width of the page
	 * @param h            The height of the page
	 * @param ml           The left margin size
	 * @param mr           The right margin size
	 * @param min_sp       The minimum spacing between words
	 * @param min_lhs      The default line-height size
	 * @param line_density The JUSTIFY line density threshold
	 * @param tab          The tab size
	 * @param head         The heading font to use
	 * @param body         The body font to use
